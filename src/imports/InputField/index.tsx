import svgPaths from "./svg-fos6raco6l";
...
function Select({ className, focused = "Off", placeholder = "On", state = "Pristine" }: SelectProps) {
  return (
    <div className={className || "relative w-[294px]"}>
...
function InputField({ className, disabled = "False", iconSide = "Right", optional = "True", showLabel = "True", size = "Large" }: InputFieldProps) {
  return (
        ...
        <div className="h-[19px] relative shrink-0" data-name="Label">
          <div className="content-stretch flex items-start relative size-full">
            <div className="[word-break:break-word] content-stretch flex gap-[7px] items-end pl-px relative shrink-0 whitespace-nowrap" data-name="Label text">
              <p className="font-['Poppins:SemiBold',sans-serif] leading-[1.2] not-italic relative shrink-0 text-[#231f20] text-[16px]">Label</p>
              <p className="font-['Montserrat:Regular',sans-serif] font-normal leading-[1.3] relative shrink-0 text-[#67686b] text-[12px]">Optional</p>
            </div>
          </div>
        </div>
        <Select className="relative shrink-0 w-[425px]" />
      </div>
    </div>
  );
}
