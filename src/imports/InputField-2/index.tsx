import svgPaths from "./svg-apjvdjgnzt";
...
function InputField({ className, disabled = "False", iconSide = "Right", optional = "False", showLabel = "True", size = "Fill" }: InputFieldProps) {
  return (
    <div className={className || "relative w-[700px]"}>
      <div className="content-stretch flex flex-col gap-[6px] items-start relative size-full">
        <div className="h-[19px] relative shrink-0 w-[700px]" data-name="Label">
        ...
        <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full" data-name="Dropdown wrapper">
          <div className="h-[44px] relative shrink-0 w-[700px]" data-name="Select">
            <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
